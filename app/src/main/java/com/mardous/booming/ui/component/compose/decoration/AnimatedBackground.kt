...
fun Modifier.animatedGradient(
    ...
    val targetBase = colors.getOrNull(0) ?: Color.Transparent
    val target1 = colors.getOrElse(1 % safeSize) { targetBase }
    val target2 = colors.getOrElse(2 % safeSize) { targetBase }
    val target3 = colors.getOrElse(3 % safeSize) { targetBase }
