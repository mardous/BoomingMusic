...
class ExtraInfoPreferenceDialog : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        val title = getString(R.string.select_extra_info_title)
        val preferenceKey = NOW_PLAYING_EXTRA_INFO
        val defaultContent = Preferences.getDefaultNowPlayingInfo()
    ...
    companion object {
        ...
        fun nowPlaying() = ExtraInfoPreferenceDialog()
    }
}
