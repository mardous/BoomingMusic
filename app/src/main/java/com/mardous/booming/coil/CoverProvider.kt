...
class CoverProvider : ContentProvider(), KoinComponent {
    ...
    private suspend fun openFileCommon(
        ...
        val masked = uri.getQueryParameter("shape") == "cookie"
    ...
    override fun getType(uri: Uri): String {
        return if (uri.getQueryParameter("shape") == "cookie") "image/png" else "image/jpeg"
    }
    ...
    companion object {
        ...
        fun getImageUri(path: String, id: String, shape: String? = null): Uri? {
            return Uri.Builder()
                ...
                .appendPath(path)
                .appendPath(id)
                .apply { if (shape != null) appendQueryParameter("shape", shape) }
                .build()
        }
    }
}
